...
public class UnitTestGameSession {
    ...
    protected final UserAnswerHandler userAnswerHandler;

    private final UIHandler uiHandler;
    private static final int NUMBER_OF_EMPTY_LINES = 30;
    String screenCleaner = "\n".repeat(NUMBER_OF_EMPTY_LINES);

    public UnitTestGameSession(OutputHandler outputHandler,
    ...
    public String getAnswerState() {
        return userAnswerHandler.getAnswerState();
    }
